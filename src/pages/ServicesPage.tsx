...
const ServicesPage: React.FC = () => {
    const procedures = [
        ...
        {
            id: 9,
            title: "Долговременная укладка ресниц",
            description: "Создание естественного изгиба ресниц без использования туши и щипцов. Идеально ровные и подкрученные ресницы на несколько недель.",
            details: [
                "Естественный изгиб",
                "Подчеркивание формы глаз",
                "Долговременный результат",
                "Уход и питание ресниц"
            ],
            duration: "1 час",
            category: "Ресницы"
        },
